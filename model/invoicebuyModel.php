...
Class invoicebuyModel Extends baseModel {
	protected $table = "invoice_buy";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_buy_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_buy WHERE invoice_buy_id != '.$id);
    }
