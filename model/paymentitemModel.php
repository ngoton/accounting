...
Class paymentitemModel Extends baseModel {
    ...
    public function deletePayment($id){
    	if ($this->getPayment($id)) {
    		return $this->delete($this->table,array('payment_item_id'=>$id));
    	}
    }
    ...
    public function getAllPaymentByWhere($id){
        return $this->query('SELECT * FROM payment_item WHERE payment_item_id != '.$id);
    }
