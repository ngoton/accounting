...
Class invoicebuyitemModel Extends baseModel {
	protected $table = "invoice_buy_item";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_buy_item_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_buy_item WHERE invoice_buy_item_id != '.$id);
    }
