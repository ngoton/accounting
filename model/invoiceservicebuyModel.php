...
Class invoiceservicebuyModel Extends baseModel {
	protected $table = "invoice_service_buy";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_service_buy_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_service_buy WHERE invoice_service_buy_id != '.$id);
    }
