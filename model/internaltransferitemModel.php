...
Class internaltransferitemModel Extends baseModel {
	protected $table = "internal_transfer_item";
    ...
    public function deleteBank($id){
    	if ($this->getBank($id)) {
    		return $this->delete($this->table,array('internal_transfer_item_id'=>$id));
    	}
    }
    ...
    public function getAllBankByWhere($id){
        return $this->query('SELECT * FROM internal_transfer_item WHERE internal_transfer_item_id != '.$id);
    }
