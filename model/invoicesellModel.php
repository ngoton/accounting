...
Class invoicesellModel Extends baseModel {
	protected $table = "invoice_sell";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_sell_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_sell WHERE invoice_sell_id != '.$id);
    }
