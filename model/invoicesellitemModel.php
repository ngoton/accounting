...
Class invoicesellitemModel Extends baseModel {
	protected $table = "invoice_sell_item";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_sell_item_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_sell_item WHERE invoice_sell_item_id != '.$id);
    }
