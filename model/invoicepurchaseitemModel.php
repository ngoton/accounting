...
Class invoicepurchaseitemModel Extends baseModel {
	protected $table = "invoice_purchase_item";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_purchase_item_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_purchase_item WHERE invoice_purchase_item_id != '.$id);
    }
