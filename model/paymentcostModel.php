...
Class paymentcostModel Extends baseModel {
    ...
    public function deletePayment($id){
    	if ($this->getPayment($id)) {
    		return $this->delete($this->table,array('payment_cost_id'=>$id));
    	}
    }
    ...
    public function getAllPaymentByWhere($id){
        return $this->query('SELECT * FROM payment_cost WHERE payment_cost_id != '.$id);
    }
