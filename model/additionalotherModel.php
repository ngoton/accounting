...
Class additionalotherModel Extends baseModel {
	protected $table = "additional_other";
    ...
    public function deleteAdditional($id){
    	if ($this->getAdditional($id)) {
    		return $this->delete($this->table,array('additional_other_id'=>$id));
    	}
    }
    ...
    public function getAllAdditionalByWhere($id){
        return $this->query('SELECT * FROM additional_other WHERE additional_other_id != '.$id);
    }
