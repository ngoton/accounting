<?php
Class detailcashController Extends baseController {
    public function index() {
        $this->view->setLayout('admin');
        if (!isset($_SESSION['userid_logined'])) {
            return $this->view->redirect('user/login');
        }
        if (!isset(json_decode($_SESSION['user_permission_action'])->detailcash) || json_decode($_SESSION['user_permission_action'])->detailcash != "detailcash") {
            $this->view->data['disable_control'] = 1;
        }
        $this->view->data['lib'] = $this->lib;
        $this->view->data['title'] = 'Sổ quỹ';
        ...
        $trangthai = $account_model->getAccountByWhere(array('account_number'=>'111'))->account_id;
        ...
        /*************/
        $this->view->show('detailcash/index');
    }
