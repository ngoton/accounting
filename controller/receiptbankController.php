<?php
Class receiptbankController Extends baseController {
    public function index() {
        ...
        $data = array(
            'where' => 'payment_bank_type=2 AND payment_type=1 AND payment_check=1 AND payment_in_ex=1',
        );
        ...
        $this->view->data['lastID'] = isset($payment_model->getPaymentByWhere(array('payment_bank_type'=>2,'payment_type'=>1,'payment_check'=>1,'payment_in_ex'=>1))->payment_document_number)?$payment_model->getPaymentByWhere(array('payment_bank_type'=>2,'payment_type'=>1,'payment_check'=>1,'payment_in_ex'=>1))->payment_document_number:0;

        /* Lấy tổng doanh thu*/
        
        /*************/
        $this->view->show('receiptbank/index');
    }
