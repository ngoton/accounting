...
Class supplierController Extends baseController {
    public function index() {
        ...
        if (!isset(json_decode($_SESSION['user_permission_action'])->supplier) || json_decode($_SESSION['user_permission_action'])->supplier != "supplier") {
    ...
    public function newcus(){
        ...
        $this->view->show('supplier/newcus');
    }
    public function editcus($id){
        ...
        if (!$id) {
            return $this->view->redirect('supplier');
        }
        $this->view->data['lib'] = $this->lib;
        ...
        $this->view->show('supplier/editcus');
    }
    ...
    public function import(){
        ...
        $this->view->show('supplier/import');
    }
